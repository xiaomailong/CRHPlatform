...
public class RundataChartDialog extends JDialog {
    ...
    public RundataChartDialog(String title, ArrayList<Rundata> dataList) {
        ...
        JPanel distanceSpeedChartPanel = ChartFactoryPanel.createSingleLineChartPanel(distanceSpeedArray, "位移-速度", "s-v", "位移(km)", "速度(km/h)");
        JPanel timeTractionElecPowerPanel = ChartFactoryPanel.createDoubleLineChartPanel(timeTractionElecPowerArray, "牵引力做功-再生能量", "牵引力做功", "再生能量", "时间(s)",
            "能量(KJ)");
