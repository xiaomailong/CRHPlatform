...
//		panel.add(N2);
		...
		panel_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "\u7535\u538B\u7279\u6027\u8BBE\u7F6E", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		JLabel label_20 = new JLabel("\u8865\u507F\u7535\u538B");
		label_20.setBounds(58, 68, 62, 15);
		panel_2.add(label_20);
		
		JLabel label_22 = new JLabel("\u8865\u507F\u7535\u538B");
	...
	public void saveTractionParameter(int trainCategoryId, int actionType) {
		...
		if (k1Str.equals("") || k2Str.equals("") || DStr.equals("")
				|| N0Str.equals("") || N2Str.equals("") || NStr.equals("")
				|| TStr.equals("") || P0Str.equals("") || P1Str.equals("")
				|| v1Str.equals("") || v2Str.equals("") || F1Str.equals("")
				|| F2Str.equals("") || vi1Str.equals("") || vi2Str.equals("")
				|| vi3Str.equals("") || I1Str.equals("") || I2Str.equals("")
				|| I3Str.equals("") || vu1Str.equals("") || vu2Str.equals("")
				|| vu3Str.equals("") || u1Str.equals("") || u2Str.equals("")
				|| u3Str.equals("") || FstStr.equals("") || D0Str.equals("") || D1Str.equals("")) {
	...
	public void calculateN() {
		if (!N0.getText().trim().equals("") && !N2.getText().trim().equals("")) {
			try {
				N.setText((Integer.parseInt(N0.getText().trim()) * Integer
						.parseInt(N2.getText().trim())) + "");
	...
	public void calculateP1() {
		if (!N.getText().trim().equals("") && !P0.getText().trim().equals("")) {
			try {
				P1.setText((Double.parseDouble(N.getText().trim()) * Double
						.parseDouble(P0.getText().trim())) + "");
			} catch (NumberFormatException e) {
				// TODO: handle exception
				JOptionPane.showMessageDialog(this, "请输入正确的数字");
				e.printStackTrace();
	...
	public void calculateF1() {
		if (!P1.getText().trim().equals("") && !v1.getText().trim().equals("")) {
			try {
				F1.setText(MyTools.numFormat(((Double.parseDouble(P1.getText()
						.trim()) * 3.6) / Double.parseDouble(v1.getText()
						.trim())))
						+ "");
			} catch (NumberFormatException e) {
				// TODO: handle exception
	...
	public void calculateF2() {
		if (!P1.getText().trim().equals("") && !v2.getText().trim().equals("")) {
			try {
				F2.setText(MyTools.numFormat(((Double.parseDouble(P1.getText()
						.trim()) * 3.6) / Double.parseDouble(v2.getText()
						.trim())))
						+ "");
			} catch (NumberFormatException e) {
				// TODO: handle exception
	...
	public void calculateFst() {
		...
		String TStr = T.getText().trim();
		String DStr = D.getText().trim();
		if (!NStr.equals("") && !k1Str.equals("") && !k2Str.equals("")
				&& !TStr.equals("") && !DStr.equals("")) {
			try {
				double FstDou = (2 * Double.parseDouble(NStr)
						* Double.parseDouble(k1Str) * Double.parseDouble(k2Str) * Double
							.parseDouble(TStr))
