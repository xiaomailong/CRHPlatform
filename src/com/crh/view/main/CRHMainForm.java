...
import com.crh.service.ExitThread;
...
public class CRHMainForm extends JFrame {
	...
	public CRHMainForm() {
		...
		/*取消软件过期
		 * if(isOverTime()){
			JOptionPane.showMessageDialog(CRHMainForm.this, "\u8F6F\u4EF6\u8BD5\u7528\u671F\u9650\u5DF2\u5230\uFF0C\u8BF7\u8D2D\u4E70\u7248\u6743\uFF01");
		}else{
			setJMenuBar(menuBar);
		}*/
...
//		new Thread(new ExitThread()).start();
	...
	public boolean isOverTime(){
		...
		Calendar deadLine = new GregorianCalendar(2015,6,15); //软件到2015年7月15号过期
