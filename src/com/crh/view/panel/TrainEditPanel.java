...
public class TrainEditPanel extends JPanel {
	...
	public TrainEditPanel() {
		...
		panel.setBorder(new TitledBorder(null, "列车信息", TitledBorder.LEADING,
		...
		JLabel label_21 = new JLabel("功率因素");
		...
		panel_1.setBorder(new TitledBorder(null, "列车编组设置",
	...
	public void saveTrainInfoAndFormation(int trainCategoryId){
		...
		if (!maxVStr.equals("") && !maxEVStr.equals("") && !conVStr.equals("")
				&& !powerConfStr.equals("") && !mzmaxStr.equals("")
				&& !a200Str.equals("") && !mzminStr.equals("")
				&& !JStr.equals("") && !slopeStr.equals("")
				&& !em1Str.equals("") && !arStr.equals("") && !dvStr.equals("")
				&& !launchfStr.equals("") && !powerFacStr.equals("")
				&& !gearm2Str.equals("") && !MStr.equals("")
				&& !aStr.equals("") && !bStr.equals("") && !cStr.equals("")
				&& !tu1Str.equals("") && !tu2Str.equals("")
				&& !bu1Str.equals("") && !bu2Str.equals("")) {
			try {
				double sum = Double.parseDouble(maxVStr) + Double.parseDouble(maxEVStr) + Double.parseDouble(conVStr)
						+ Double.parseDouble(mzmaxStr) + Double.parseDouble(a200Str) + Double.parseDouble(mzminStr) + Double.parseDouble(JStr) 
						+ Double.parseDouble(slopeStr) + Double.parseDouble(em1Str) + Double.parseDouble(arStr) + Double.parseDouble(dvStr) 
						+ Double.parseDouble(launchfStr) + Double.parseDouble(powerFacStr) + Double.parseDouble(gearm2Str) + Double.parseDouble(MStr) 
						+ Double.parseDouble(aStr) + Double.parseDouble(bStr) + Double.parseDouble(cStr);
			} catch (NumberFormatException e) {
