...
/**
 * 2014.10.15 最小时分仿真的“动画运行”
 * @author huhui
 *
 */
public class MinTimeAutoCRHPanel extends JPanel implements Runnable {
	 ...
	 * @param runDataList
	 */
	public MinTimeAutoCRHPanel(int routeId, ArrayList<Rundata> runDataList){
