...
public class BrakeConfPanel extends JPanel {
    ...
    public BrakeConfPanel() {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (categoryId == 0) {
                    ...
                    electricBrakeCreater(-1, categoryId);
        ...
        brakeCharacterPanel = new ChartPanel(BrakeCharacterChart.createBlankChart("制动特性曲线"));
        ...
        brakePerformancePanel = new ChartPanel(BrakeCharacterChart.createBlankChart("制动性能曲线"));
        ...
        panel_3.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "\u5217\u8F66\u5236\u52A8\u7279\u6027\u8BA1\u7B97",
        ...
        panel2TitleBorder = new TitledBorder(UIManager.getBorder("TitledBorder.border"), "0-" + (int) SPEED_300, TitledBorder.LEADING, TitledBorder.TOP, null,
            null);
    ...
    public void refreshBrakeLevelPanelByCheckBox() {
        ...
        _1ACheckBox.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                BrakeCharacterChart.lineStateChanger("0", _1ACheckBox.isSelected());
            }
        });
        if (brakeLevelBoolean[0] == true) {
        ...
        _1BCheckBox.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                BrakeCharacterChart.lineStateChanger("1", _1BCheckBox.isSelected());
            }
        });
        if (brakeLevelBoolean[1] == true) {
        ...
        for (int i = 2; i <= 13; i++) {
            ...
            checkBox.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    BrakeCharacterChart.lineStateChanger(checkBox.getText(), checkBox.isSelected());
                }
            });
            if (brakeLevelBoolean[i] == true) {
    ...
    public void drawBrakeCharacterChart(int trainCategoryId) {
        ...
        // 0.列车提供制动力曲线
        final JCheckBoxMenuItem checkBoxMenuItem_0 = new JCheckBoxMenuItem("列车制动力曲线");
        checkBoxMenuItem_0.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
        ...
        popupMenu.add(checkBoxMenuItem_0);
        // 1.空气制动力曲线
        final JCheckBoxMenuItem checkBoxMenuItem_1 = new JCheckBoxMenuItem("再生制动曲线");
        checkBoxMenuItem_1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
     ...
     * @param trainCategoryId
     */
    public static void electricBrakeCreater(int id, int trainCategoryId) {
        electricBrakeList.clear();
        String[] parameters = BrakeConfPanelService.getFiveParameters(id, trainCategoryId);// 获得N,k1,k2,T,D,F2
        double Fst = 2 * Double.parseDouble(parameters[3]) * Double.parseDouble(parameters[0]) * Double.parseDouble(parameters[1])
                     * Double.parseDouble(parameters[4]) / 1000 / Double.parseDouble(parameters[2]);// KN
...
class BrakeCharacterChart {
    ...
    public JFreeChart createChart(XYDataset dataset) {
        ...
        JFreeChart jFreeChart = new JFreeChart("制动特性", JFreeChart.DEFAULT_TITLE_FONT, xyPlot, true);
        return jFreeChart;
    }
    ...
    public static void lineStateChanger(String checkBoxText, boolean visible) {
        xySplineRenderer.setSeriesVisible(Integer.parseInt(checkBoxText), visible);
    }
