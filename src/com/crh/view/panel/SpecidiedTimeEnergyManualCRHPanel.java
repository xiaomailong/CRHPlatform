...
/**
 * 2014.10.15固定时分节能控制运行仿真的“动画运行”
 * @author huhui
 *
 */
public class SpecidiedTimeEnergyManualCRHPanel extends JPanel {
	 ...
	 * @param runDataList
	 */
	public SpecidiedTimeEnergyManualCRHPanel(int routeId, ArrayList<Rundata> runDataList){
