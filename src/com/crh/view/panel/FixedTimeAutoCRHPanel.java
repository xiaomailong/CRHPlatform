...
/**
 * 2014.10.15 固定时分运行仿真的“动画运行”
 * @author huhui
 *
 */
public class FixedTimeAutoCRHPanel extends JPanel implements Runnable {
	 ...
	 * @param runDataList
	 */
	public FixedTimeAutoCRHPanel(int routeId, ArrayList<Rundata> runDataList){
