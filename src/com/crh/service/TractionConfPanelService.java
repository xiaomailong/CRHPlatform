...
public class TractionConfPanelService {
	...
	public static boolean saveTrainTractionConf(TrainTractionConf trainTractionConf, int trainCategoryId, int tractionId, int actionType, int type) {
		...
		boolean b = false;
		if(newType < 6){
			String insertSQL = "insert into train_traction_conf values(null,"
					+ trainTractionConf.getK1() + "," + trainTractionConf.getK2()
					+ "," + trainTractionConf.getD() + ","
					+ trainTractionConf.getN0() + "," + trainTractionConf.getN2()
					+ "," + trainTractionConf.getN() + ","
					+ trainTractionConf.getT() + "," + trainTractionConf.getP0()
					+ "," + trainTractionConf.getP1() + ","
					+ trainTractionConf.getV1() + "," + trainTractionConf.getV2()
					+ "," + trainTractionConf.getF1() + ","
					+ trainTractionConf.getF2() + "," + trainTractionConf.getFst()
					+ "," + trainTractionConf.getVi1() + ","
					+ trainTractionConf.getI1() + "," + trainTractionConf.getVi2()
					+ "," + trainTractionConf.getI2() + ","
					+ trainTractionConf.getVi3() + "," + trainTractionConf.getI3()
					+ "," + trainTractionConf.getVu1() + ","
					+ trainTractionConf.getU1() + "," + trainTractionConf.getVu2()
					+ "," + trainTractionConf.getU2() + ","
					+ trainTractionConf.getVu3() + "," + trainTractionConf.getU3()
					+ "," + trainCategoryId + ","+ trainTractionConf.getD0() + "," + trainTractionConf.getD1() + ")";
	...
	public static boolean saveTrainTractionLevelConf(int trainCategoryId, TrainTractionLevelConf bean){
		...
		sqlHelper.update(delSQL, null);
		String sql = "INSERT INTO train_traction_level_conf VALUES(NULL,"
				+ bean.get_1_0() + "," + bean.get_1_1() + "," + bean.get_1_2()
				+ "," + bean.get_1_3() + "," + bean.get_2_0() + ","
				+ bean.get_2_1() + "," + bean.get_2_2() + "," + bean.get_2_3()
				+ "," + bean.get_3_0() + "," + bean.get_3_1() + ","
				+ bean.get_3_2() + "," + bean.get_3_3() + "," + bean.get_4_0()
				+ "," + bean.get_4_1() + "," + bean.get_4_2() + ","
				+ bean.get_4_3() + "," + bean.get_4_4() + "," + bean.get_5_0()
				+ "," + bean.get_5_1() + "," + bean.get_5_2() + ","
				+ bean.get_5_3() + "," + bean.get_5_4() + "," + bean.get_6_0()
				+ "," + bean.get_6_1() + "," + bean.get_6_2() + ","
				+ bean.get_6_3() + "," + bean.get_6_4() + "," + bean.get_7_0()
				+ "," + bean.get_7_1() + "," + bean.get_7_2() + ","
				+ bean.get_7_3() + "," + bean.get_7_4() + "," + bean.get_8_0()
				+ "," + bean.get_8_1() + "," + bean.get_8_2() + ","
				+ bean.get_8_3() + "," + bean.get_8_4() + "," + bean.get_9_0()
				+ "," + bean.get_9_1() + "," + bean.get_9_2() + ","
				+ bean.get_9_3() + "," + bean.get_9_4() + "," + bean.get_10_0()
				+ "," + bean.get_10_1() + "," + bean.get_10_2() + ","
				+ bean.get_10_3() + "," + bean.get_10_4() + ","
				+ bean.get_10_5() + "," + bean.get_10_6() + ","
				+ bean.get_11_0() + "," + bean.get_11_1() + ","
				+ bean.get_11_2() + "," + bean.get_11_3() + ","
				+ bean.get_11_4() + "," + bean.get_11_5() + ","
				+ bean.get_11_6() + "," + bean.get_12_0() + ","
				+ bean.get_12_1() + "," + bean.get_12_2() + ","
				+ bean.get_12_3() + "," + bean.get_12_4() + ","
				+ bean.get_12_5() + "," + bean.get_12_6() + ","
				+ bean.get_13_0() + "," + bean.get_13_1() + ","
				+ bean.get_13_2() + "," + bean.get_13_3() + ","
				+ bean.get_13_4() + "," + bean.get_13_5() + ","
				+ bean.get_13_6() + "," + bean.get_14_0() + ","
				+ bean.get_14_1() + "," + bean.get_14_2() + ","
				+ bean.get_14_3() + "," + bean.get_14_4() + ","
				+ bean.get_14_5() + "," + bean.get_14_6() + ","
				+ bean.get_15_0() + "," + bean.get_15_1() + ","
				+ bean.get_15_2() + "," + bean.get_15_3() + ","
				+ bean.get_15_4() + "," + trainCategoryId + ")";
		sqlHelper.update(sql, null);
		return true;
	}
