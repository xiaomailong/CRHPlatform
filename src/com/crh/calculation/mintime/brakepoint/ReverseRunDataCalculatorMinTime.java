...
public class ReverseRunDataCalculatorMinTime {
	 ...
	 */
	public void saveRundataBackBeans(int runtime,double speed,double distance,double location, double comBrakePower, double elecBrakePower, double cp, double tractionGridCurrent, double comBrakeGridCurrent, double acceleration, double actualElecBrakeForcePower){
	...
	public ArrayList<Rundata> calculatorRundataBack(TrainStopStation station) {
		...
		while (true) {
			...
			this.saveRundataBackBeans(i+count, currentSpeed, Si, location, comBrakePower, elecBrakePower, cp, tractionGridCurrent, comBrakeGridCurrent, acceleration, actualElecBrakeForcePower);
