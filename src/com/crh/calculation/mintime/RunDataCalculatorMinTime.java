...
public class RunDataCalculatorMinTime {
     ...
     * @param randomError
     */
    public RunDataCalculatorMinTime(String routeName, String trainNum, int trainCategoryId, String tractionLevel, double brakeLevel, double maxSpeed,
                                    double randomError) {
     ...
     */
    public void saveRundataBeans(int runtime, double speed, double distance, double location, double tractionPower, double power, double cp,
                                 double tractionGridCurrent, double comBrakeGridCurrent, double acceleration, double tractionForce, double actualTractionPower) {
    ...
    public ArrayList<Rundata> calculateRunData(TrainStopStation station, TrainStopStation nextStation) {
        ...
        double tractionPower = 0, power = 0, actualTractionPower = 0, g = 9.8;
        ...
        while (true) {
            ...
            this.saveRundataBeans((i + count), currentSpeed, Si, location, tractionPower, power, cp, tractionGridCurrent, comBrakeGridCurrent, acceleration,
                tractionForce, actualTractionPower);
            ...
            if (isSpeedLimited == 0) {//正常情况
                ...
                tractionPower += (AirFrictionMinTime.getAirFriction(currentSpeed) + cp * AirFrictionMinTime.m * g / 1000000) * (Si - S);
            }
