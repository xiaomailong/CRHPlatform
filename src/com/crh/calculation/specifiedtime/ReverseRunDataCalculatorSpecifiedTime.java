...
/**
 *  2014.8.10计算从各个车站反向计算得到刹车点
 * @author huhui
 */
public class ReverseRunDataCalculatorSpecifiedTime {
	 ...
	 * @param netCurrent
	 */
	public ReverseRunDataCalculatorSpecifiedTime(ArrayList<Slope> slopeList, ArrayList<Curve> curveList, NetCurrent netCurrent){
	...
	public double [] calculateT3AndS3(double v, int mode) {
		...
		while (true) {
			...
			if(mode == RunDataCalculatorSpecifiedTime.CAL_SAVE_MODE){
