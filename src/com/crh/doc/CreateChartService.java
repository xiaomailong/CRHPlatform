...
public class CreateChartService {
    ...
    public void createData() {
        ...
        //查询选中的牵引配置
        int tractionId = TractionConfPanelService.getSelectedTractionConf(trainCategoryId);

        //1.10	列车牵引特性曲线
        if (TractionForceMinTime.tractionType == 0) {
            ArrayList<CurveFormulaBean> chartDataList = TractionConfPanel.getTractionData(tractionId, trainCategoryId);
        ...
        //1.11.2	电制动
        BrakeConfPanel.electricBrakeCreater(tractionId, trainCategoryId);
     ...
     * @param picName 图片保存名称
     */
    public void createAndSaveDoubleLineChart(double[][] xyData, String chartName, String lineName1, String lineName2, String xLabel, String yLabel,
                                             String picName) {
