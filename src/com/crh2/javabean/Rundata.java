...
public class Rundata {
    ...
    public String toString() {
        return "Rundata [runtime=" + runtime + ", speed=" + speed + ", lastSpeed=" + lastSpeed + ", distance=" + distance + ", location=" + location + ", cp="
               + cp + ", printCp=" + printCp + ", routeId=" + routeId + ", slopeFlag=" + slopeFlag + ", curveFlag=" + curveFlag + ", isConstantSpeed="
               + isConstantSpeed + ", power=" + power + ", acceleration=" + acceleration + ", tractionForce=" + tractionForce + ", brakeForce=" + brakeForce
               + ", eleBrakeForce=" + eleBrakeForce + ", airForce=" + airForce + ", otherForce=" + otherForce + ", tractionPower=" + tractionPower
               + ", averageAcc=" + averageAcc + ", manulBrakeForcePower=" + manulBrakeForcePower + ", elecBrakeForcePower=" + elecBrakeForcePower
               + ", comBrakeForcePower=" + comBrakeForcePower + ", tractionGridCurrent=" + tractionGridCurrent + ", comBrakeGridCurrent=" + comBrakeGridCurrent
               + ", actualTractionPower=" + actualTractionPower + ", actualElecBrakeForcePower=" + actualElecBrakeForcePower + ", totalPower=" + totalPower
               + "]";
    }
